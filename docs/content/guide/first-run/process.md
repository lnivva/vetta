...
| `--file /tmp/test.wav` | Path to the audio file generated in the [previous step](/guide/first-run/test-audio). |  
...
| `--print`              | **Debug mode.** Streams the transcript to your terminal in real time.                 |
